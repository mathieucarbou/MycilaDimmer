...
[**ClassList**](annotated.md) **>** [**Mycila**](namespaceMycila.md) **>** [**DFRobotDimmer**](classMycila_1_1DFRobotDimmer.md)



_DFRobot DFR1071/DFR1073/DFR0971 I2C controlled 0-10V/0-5V dimmer implementation for voltage regulators controlled by a 0-10V/0-5V analog signal._ 
...
|  uint8\_t | [**getChannel**](#function-getchannel) () const<br> |
|  uint8\_t | [**getDeviceAddress**](#function-getdeviceaddress) () const<br> |
|  [**Output**](classMycila_1_1DFRobotDimmer.md#enum-output) | [**getOutput**](#function-getoutput) () const<br> |
|  uint8\_t | [**getResolution**](#function-getresolution) () const<br>_Get the PWM resolution in bits._  |
|  [**SKU**](classMycila_1_1DFRobotDimmer.md#enum-sku) | [**getSKU**](#function-getsku) () const<br> |
|  TwoWire & | [**getWire**](#function-getwire) () const<br> |
|  void | [**setChannel**](#function-setchannel) (uint8\_t channel) <br>_Set channel number._  |
|  void | [**setDeviceAddress**](#function-setdeviceaddress) (uint8\_t deviceAddress) <br>_I2C address of the device._  |
|  void | [**setOutput**](#function-setoutput) ([**Output**](classMycila_1_1DFRobotDimmer.md#enum-output) output) <br>_Set output mode of the device: 0-5V or 0-10V._  |
|  void | [**setSKU**](#function-setsku) ([**SKU**](classMycila_1_1DFRobotDimmer.md#enum-sku) sku) <br> |
|  void | [**setWire**](#function-setwire) (TwoWire & wire) <br> |
| virtual const char \* | [**type**](#function-type) () override const<br> |
| virtual  | [**~DFRobotDimmer**](#function-dfrobotdimmer) () <br> |
...
* `channel` output channel 
 0: Channel 0 (valid when PWM0 output is configured) 
 1: Channel 1 (valid when PWM1 output is configured) 
 2: All channels (valid when configuring dual channel output) 
...
_Set output mode of the device: 0-5V or 0-10V._ 
```C++
